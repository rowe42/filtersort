 ...
 */
public class ConsistentTheBigEntityValidator_ implements ConstraintValidator<ConsistentTheBigEntity_, TheBigEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentTheBigEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentTheBigEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(TheBigEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
