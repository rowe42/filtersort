 ...
 */
public class ConsistentCustomEntityValidator_ implements ConstraintValidator<ConsistentCustomEntity_, CustomEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentCustomEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentCustomEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(CustomEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
