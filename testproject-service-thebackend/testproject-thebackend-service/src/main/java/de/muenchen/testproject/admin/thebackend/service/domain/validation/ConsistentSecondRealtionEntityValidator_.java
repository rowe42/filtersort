 ...
 */
public class ConsistentSecondRealtionEntityValidator_ implements ConstraintValidator<ConsistentSecondRealtionEntity_, SecondRealtionEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentSecondRealtionEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentSecondRealtionEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(SecondRealtionEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
