 ...
 * If used as generated by Barrakuda this service will be autowired and called by SecondRealtionEntity_ResourceProcessor.
 */
@Service
public class SecondRealtionEntity_ResourceServiceImpl implements SecondRealtionEntity_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(SecondRealtionEntity_ResourceServiceImpl.class);
