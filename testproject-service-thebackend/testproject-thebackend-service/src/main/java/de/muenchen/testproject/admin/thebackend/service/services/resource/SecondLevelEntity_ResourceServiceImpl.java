 ...
 * If used as generated by Barrakuda this service will be autowired and called by SecondLevelEntity_ResourceProcessor.
 */
@Service
public class SecondLevelEntity_ResourceServiceImpl implements SecondLevelEntity_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(SecondLevelEntity_ResourceServiceImpl.class);
