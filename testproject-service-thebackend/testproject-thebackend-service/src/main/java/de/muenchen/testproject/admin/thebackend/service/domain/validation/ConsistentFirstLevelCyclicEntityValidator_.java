 ...
 */
public class ConsistentFirstLevelCyclicEntityValidator_ implements ConstraintValidator<ConsistentFirstLevelCyclicEntity_, FirstLevelCyclicEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentFirstLevelCyclicEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentFirstLevelCyclicEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(FirstLevelCyclicEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
