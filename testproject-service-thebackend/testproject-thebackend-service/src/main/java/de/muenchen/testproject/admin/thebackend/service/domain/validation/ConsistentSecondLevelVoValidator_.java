...
import de.muenchen.testproject.admin.thebackend.service.gen.domain.SecondLevelVo_;
 ...
 */
public class ConsistentSecondLevelVoValidator_ implements ConstraintValidator<ConsistentSecondLevelVo_, SecondLevelVo_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentSecondLevelVoValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentSecondLevelVo_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(SecondLevelVo_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
