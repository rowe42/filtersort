...
import de.muenchen.testproject.admin.thebackend.service.gen.services.resource.CustomEntity_ResourceService;
 ...
 * If used as generated by Barrakuda this service will be autowired and called by CustomEntity_ResourceProcessor.
 */
@Service
public class CustomEntity_ResourceServiceImpl implements CustomEntity_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(CustomEntity_ResourceServiceImpl.class);
	 ...
	 */
	public Resource<CustomEntity_> process(Resource<CustomEntity_> resource){
