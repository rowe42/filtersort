 ...
 */
public class ConsistentFallValidator_ implements ConstraintValidator<ConsistentFall_, Fall_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentFallValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentFall_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(Fall_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
