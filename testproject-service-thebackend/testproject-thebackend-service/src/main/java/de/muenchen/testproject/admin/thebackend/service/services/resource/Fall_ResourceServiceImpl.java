 ...
 * If used as generated by Barrakuda this service will be autowired and called by Fall_ResourceProcessor.
 */
@Service
public class Fall_ResourceServiceImpl implements Fall_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(Fall_ResourceServiceImpl.class);
