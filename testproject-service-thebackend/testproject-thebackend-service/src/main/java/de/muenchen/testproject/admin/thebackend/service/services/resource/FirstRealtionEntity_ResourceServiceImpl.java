 ...
 * If used as generated by Barrakuda this service will be autowired and called by FirstRealtionEntity_ResourceProcessor.
 */
@Service
public class FirstRealtionEntity_ResourceServiceImpl implements FirstRealtionEntity_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(FirstRealtionEntity_ResourceServiceImpl.class);
