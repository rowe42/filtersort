 ...
 */
public class ConsistentAbstractEntityValidator_ implements ConstraintValidator<ConsistentAbstractEntity_, AbstractEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentAbstractEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentAbstractEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(AbstractEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
