 ...
 * If used as generated by Barrakuda this service will be autowired and called by FirstLevelCyclicEntity_ResourceProcessor.
 */
@Service
public class FirstLevelCyclicEntity_ResourceServiceImpl implements FirstLevelCyclicEntity_ResourceService {
	
	private static final Logger LOG = LoggerFactory.getLogger(FirstLevelCyclicEntity_ResourceServiceImpl.class);
