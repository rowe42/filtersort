 ...
 */
public class ConsistentSecondLevelCyclicEntityValidator_ implements ConstraintValidator<ConsistentSecondLevelCyclicEntity_, SecondLevelCyclicEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentSecondLevelCyclicEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentSecondLevelCyclicEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(SecondLevelCyclicEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
