...
import de.muenchen.testproject.admin.thebackend.service.gen.domain.ThirdLevelVo_;
 ...
 */
public class ConsistentThirdLevelVoValidator_ implements ConstraintValidator<ConsistentThirdLevelVo_, ThirdLevelVo_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentThirdLevelVoValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentThirdLevelVo_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(ThirdLevelVo_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
