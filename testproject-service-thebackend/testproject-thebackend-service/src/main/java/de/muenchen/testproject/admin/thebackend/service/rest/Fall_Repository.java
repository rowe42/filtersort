...
import de.muenchen.testproject.admin.thebackend.service.gen.rest.Generated_Fall_Repository;
 ...
 */
/**
* Provides a Repository for a {@link Fall_}. This Repository can be exported as a REST Resource.
* <p>
...
@RepositoryRestResource(exported = true,
	path="falls", collectionResourceRel="falls")
@PreAuthorize("hasPermission(T(de.muenchen.testproject.admin.thebackend.service.gen.security.ResourcesEnum).thebackend_READ_Fall.name(),'Entitlements')")
public interface Fall_Repository extends Generated_Fall_Repository {
}
