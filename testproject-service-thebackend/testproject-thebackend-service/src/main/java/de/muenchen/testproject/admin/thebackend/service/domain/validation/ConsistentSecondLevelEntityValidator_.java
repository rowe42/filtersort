 ...
 */
public class ConsistentSecondLevelEntityValidator_ implements ConstraintValidator<ConsistentSecondLevelEntity_, SecondLevelEntity_> {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentSecondLevelEntityValidator_.class);

	/**
	 * {@inheritDoc}
	 */
    @Override
    public void initialize(ConsistentSecondLevelEntity_ constraintAnnotation) {
	 ...
	 */
    @Override
    public boolean isValid(SecondLevelEntity_ value, ConstraintValidatorContext context) {
    	boolean valid = true;
