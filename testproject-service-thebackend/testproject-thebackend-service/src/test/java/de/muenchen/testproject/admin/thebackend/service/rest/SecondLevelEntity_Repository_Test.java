...
public class SecondLevelEntity_Repository_Test {

	@Autowired
	SecondLevelEntity_Repository repository;
	...
	public void testSave(){
	    ...
	    // initialize
	    SecondLevelEntity_ original = new SecondLevelEntity_();
	    original.setText1("test");
	    original.setText2("test");
	    original.setText3("test");
	    
	    // persist
	    original = repository.save(original);
	    
	    // check
	    SecondLevelEntity_ persisted = repository.findOne(original.getOid());
