...
public class ConsistentFirstLevelEntityValidator__Test {

	private static final Logger LOG = LoggerFactory.getLogger(ConsistentFirstLevelEntityValidator__Test.class);

	private ConsistentFirstLevelEntityValidator_ validator;

	private FirstLevelEntity_  firstLevelEntity;

    private ConstraintValidatorContext constraintValidatorContext;

    @Before
    public void setUp() throws Exception {
    	validator = new  ConsistentFirstLevelEntityValidator_();
    	firstLevelEntity = new FirstLevelEntity_();
    ...
    public void isValid() {
    	...
    	// "firstLevelEntity" with example values.
    	FirstLevelEntity_ firstLevelEntity = new FirstLevelEntity_();
    	firstLevelEntity.setText1("test");
    	firstLevelEntity.setText2("test");
    	
    	assertTrue(validator.isValid(firstLevelEntity, constraintValidatorContext));
