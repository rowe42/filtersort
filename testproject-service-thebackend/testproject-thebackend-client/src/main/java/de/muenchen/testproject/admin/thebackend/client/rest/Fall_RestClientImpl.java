...
import de.muenchen.testproject.admin.thebackend.client.domain.Fall_DTO;
 ...
 */
public class Fall_RestClientImpl extends RestClientImpl<Fall_DTO> {

	private static final Logger LOG = LoggerFactory.getLogger(Fall_RestClientImpl.class);
	 ...
	 */
	public Fall_RestClientImpl(RestTemplate restTemplate, final URI basePath) {
		super(restTemplate,
				basePath,
				"falls",
				new ParameterizedTypeReference<Resources<Resource<Fall_DTO>>>() {},
				new ParameterizedTypeReference<Resource<Fall_DTO>>() {});
	}
	 ...
	 * @param basePath The base URI of the REST Server.
	 */
	public Fall_RestClientImpl(RestTemplate restTemplate, final String basePath) {
